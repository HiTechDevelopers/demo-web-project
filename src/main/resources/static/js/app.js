...
app.controller('mytable', function ($scope, $http) {
  ...
  $scope.loadData = function () {
    $scope.launches = []
    $http.get('http://ec2-52-11-209-82.us-west-2.compute.amazonaws.com:8080/data/upcoming_launches')
...
app.controller('mytable2', function ($scope, $http) {
  ...
  $scope.loadData2 = function () {
    $scope.launches = []
    $http.get('http://ec2-52-11-209-82.us-west-2.compute.amazonaws.com:8080/data/past_launches')
      .success(function (data) {
